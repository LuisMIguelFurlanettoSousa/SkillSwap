        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Troque <strong>conhecimento</strong> <span>&</span> <br />
                <strong>colabore</strong> <em className="italic">academicamente</em>
              </h1>
            </motion.div>
            ...
            >
              Conecte-se com colegas universitários, ofereça ajuda em disciplinas que domina e encontre auxílio nas
              matérias que precisa. Crie um ecossistema colaborativo de aprendizado.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Confiado por estudantes de</p>
              <div className="flex items-center justify-center gap-8">
                {/* University Icons */}
                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(231,138,83,0.5)] transition-all duration-300">
