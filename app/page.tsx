    ...
    <div className="min-h-screen w-full relative bg-black">
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-[#e78a53] to-[#e78a53]/80 rounded-full flex items-center justify-center">
              <svg
            ...
            <span className="font-bold text-lg text-foreground">Skill Swap</span>
          </div>
        </a>
      ...
      <header className="sticky top-4 z-[9999] mx-4 flex w-auto flex-row items-center justify-between rounded-full bg-background/80 backdrop-blur-sm border border-border/50 shadow-lg md:hidden px-4 py-3">
        <a className="flex items-center justify-center gap-2" href="/">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-gradient-to-br from-[#e78a53] to-[#e78a53]/80 rounded-full flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <span className="font-bold text-base text-foreground">Skill Swap</span>
          </div>
        </a>
